...
#+begin_src racket
#`(foo (+ 2 1) (+ 2 2))
↝ #<syntax:intro.rkt:28:2 (foo (+ 2 1) (+ 2 2))>
#+end_src
...
(define variable 5)
#`(foo (+ 2 1) variable)
↝ #<syntax:intro.rkt:28:2 (foo (+ 2 1) variable)>
#+end_src
...
#+begin_src racket
#`(foo (+ 2 1) #,(+ 2 2))
↝ #<syntax:intro.rkt:28:2 (foo (+ 2 1) 4)>
#+end_src
...
(define variable 5)
#`(foo (+ 2 1) #,variable)
↝ #<syntax:intro.rkt:28:2 (foo (+ 2 1) 5)>
#+end_src
...
#+HTML: <div style="max-width:700px;padding-left:130px">
[[file:images/wittgenstein.png]]
#+HTML: </div>
